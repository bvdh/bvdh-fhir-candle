...
public class AuthorizationTests : IClassFixture<AuthorizationTestFixture>
{
    ...
    public AuthorizationTests(
        AuthorizationTestFixture fixture,
    ...
    public void TestSmartConfig()
    {
        ...
        SmartWellKnown smartWellKnown = _fixture.AuthR4.SmartConfigurationByTenant[_fixture.ConfigR4.ControllerName];
    ...
    public void TestSmartClientRegistrationWithKeysFails(string publicJson)
    {
        ...
        FhirCandle.Authorization.Models.SmartClientRegistration clientRegistration = new()
        {
            ClientName = iss,
            KeySet = publicKeySet,
        };

        if (!_fixture.AuthR4.SmartClients.TryGetValue(iss, out SmartClientInfo? clientInfo) ||
            (clientInfo == null))
        {
